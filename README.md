...
| --- | --- | --- | --- |
| `v0.15.11` | Python 3.11+ | `physicsguard` | MIT |
...
PhysicsGuard `v0.15.11` includes strict, receipt-driven task-local model revision loops and low-fidelity audit relations for:
...
PhysicsGuard `v0.15.11` 包含严格、由原生回执驱动的任务局部模型迭代和这些低保真审计关系：
