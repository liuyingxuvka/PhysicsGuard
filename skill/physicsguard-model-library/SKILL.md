...
## Entrypoint Scope
Covers physicsguard-model-library plus explicitly routed local materials; no unrelated repos, private files, external services, publication, or release claims unless requested and routed.
...
## Use When
Use when the request matches physicsguard-model-library and needs this governed workflow, materials, checks, or handoff behavior.
## Do Not Use When
