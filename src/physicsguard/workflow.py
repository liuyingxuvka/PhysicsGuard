...
def project_record_payload(root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "policy": {
            ...
            "require_explicit_database_lifecycle_for_local_databases": True,
            "require_database_project_intake_for_catalog_admission": True,
            "require_database_maintenance_audit_for_database_handoff": True,
            "require_database_history_for_lifecycle_writes": True,
...
def audit_project(root: Path) -> dict[str, Any]:
    ...
    if not isinstance(policy, dict):
        ...
        for key in (
            ...
            "require_explicit_database_lifecycle_for_local_databases",
            "require_database_project_intake_for_catalog_admission",
            "require_database_maintenance_audit_for_database_handoff",
            "require_database_history_for_lifecycle_writes",
