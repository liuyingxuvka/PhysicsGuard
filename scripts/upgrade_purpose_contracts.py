...
ROUTE_ENTRIES: dict[str, dict[str, Any]] = {
    ...
    "physicsguard-audit-closure": {
        ...
        "minimum_inputs": ["requested_claim", "closure_plan", "native_receipts", "open_blockers", "current_whole_or_affected_blueprint_review", "portable_bundle_status_if_supplied", "current_execution_receipts_if_claimed"],
        "required_outputs": ["closure_status", "safe_claim", "blueprint_scope_fingerprint", "blueprint_depth_and_first_gap", "portable_bundle_identity", "portable_query_status", "frozen_case_status", "current_execution_status", "execution_claim_licensed", "blockers", "next_actions"],
        ...
        "native_route_load_when": ["route_selected_and_domain_execution_required", "blueprint_affected_closure_required", "blueprint_whole_boundary_closure_required", "portable_blueprint_bundle_closure_required"],
        "native_route_required_for": ["target_native_domain_workflow", "blueprint_closure_projection", "portable_blueprint_bundle_claim_boundary"],
        "workflow": [
            "Bind the exact requested claim and current native receipt inventory.",
            "Load the native route protocol and reconcile failures, skips, stale evidence, mappings, refinements, predictive conditions, and any supplied portable bundle identity or query gap.",
            "Keep frozen bundle cases and current target-native execution as separate states; return one exact closure state and a claim that does not exceed current evidence.",
        ],
    },
    "physicsguard-candidate-model-blueprint": {
        ...
        "minimum_inputs": ["validated_hierarchy", "independent_target_inventory", "current_blueprint_or_authoring_target", "blueprint_artifact_root", "explicit_material_root_if_declared", "ready_blocks", "interface_inventory", "model_semantics", "portable_bundle_output_if_requested", "portable_bundle_selector_if_requested"],
        "required_outputs": ["candidate_blueprint", "physical_blueprint_review", "blueprint_fingerprint", "material_root_disposition", "native_execution_status", "deepest_licensed_layer", "first_gap", "safe_claim", "portable_bundle_status_and_identity", "portable_query_identity_and_gaps", "execution_claim_licensed", "generation_eligibility", "rollout_boundary", "blockers"],
        ...
        "native_route_load_when": ["route_selected_and_domain_execution_required", "blueprint_summary_required", "blueprint_affected_slice_required", "blueprint_author_or_full_review_required", "explicit_material_root_or_fmi_observation_required", "portable_blueprint_bundle_export_or_query_required"],
        "native_route_required_for": ["target_native_domain_workflow", "canonical_physical_blueprint_authority", "portable_physical_blueprint_interchange"],
        "workflow": [
            ...
            "Use the full projection only for authoring or a whole-boundary review. On explicit request, materialize one portable bundle, return compact status by default, or query exactly one selector while preserving every identity-only and execution-licensing gap.",
...
BLUEPRINT_ROUTE_GUARD_CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "physicsguard-audit-closure": blueprint_contract(
        ...
        claim_boundary="Closure is limited to the exact current affected or full review denominator, achieved depth, first gap, native evidence, outside-scope rows, and safe claim. A portable bundle is frozen interpretation content with observed-at-export execution unlicensed; it cannot author, requalify, refresh, or prove current native execution.",
        additional_block_on=(
            (
                "blueprint_bundle_presence_promoted_to_closure",
                "bundle presence, bundle load, or an AI answer is treated as current evidence, native execution, high-fidelity reconstruction, or closure",
            ),
            (
                "blueprint_frozen_case_promoted_to_current_execution",
                "a frozen case pass from the portable bundle is reported as current target-native execution or fresh validation",
            ),
            (
                "blueprint_identity_only_terminal_promoted",
                "portable_query_identity_only_terminal is omitted, repaired by scanning, or promoted to resolved content",
            ),
        ),
    ),
    "physicsguard-candidate-model-blueprint": blueprint_contract(
        ...
        additional_block_on=(
            ...
            (
                ...
                "the full bundle is emitted as the default prompt payload, more than one deep selector is accepted, a byte budget is bypassed, or an identity-only terminal is silently repaired",
            ),
            (
                "blueprint_portable_execution_promoted",
                "bundle presence, observed-at-export status, a frozen-case pass, or an AI answer is promoted to current native execution, fresh evidence, or high-fidelity reconstruction",
            ),
        ),
    ),
